...
namespace spMain.QData.DataFormat {
  public class MbtTickHttp {

    public static Quote GetSummaryQuote(List<MbtTickHttp> ticks) {
    ...
    public bool IsEqual(MbtTickHttp t) {
      return (this._date == t._date) && (this._price == t._price) && (this._volume == t._volume) &&
        (this._condition == t._condition) && (this._type == t._type);
    }

    public MbtTickHttp(int no, DateTime date, double price, long volume, int condition, int type) {
